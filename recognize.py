...
modelNN = load("F:\\LYDINC\\AI\\robot_lydinc\\model\\NN\\modelNN_Facenet_adam_relu_3_64.joblib")
modelSVM = load("F:\\LYDINC\\AI\\robot_lydinc\\model\\SVM\\modelSVM_Facenet.joblib")
